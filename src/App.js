...
class App extends Component {
  ...
  componentDidMount() {
    ...
    const videos = (this.videos = Array.from(
  ...
  render() {
    const docked = window.innerWidth > 600;
    const isPaused =
      this.videos && !!this.videos.length && this.videos[0].paused;
    return (
        ...
        <div className="App-content">
          <div>
            <p className="App-text">
              Hi, I'm a tinkerer and developer, since making this I worked at
              aiden.ai, a startup, which was acquired by Twitter. This is since
              out of date, but some things are on GitHub if you're interested
              while I find time to update this page
            </p>
            <a className="no-color" href="https://github.com/ayroblu">
              <GoMarkGithub size={50} />
            </a>
          </div>
          {false && (
            <div id="software">
              <h2 className="SectionTitle">Software Skills</h2>
              <Software />
            </div>
          )}
          <div id="npm" className="App-text">
            ...
            <div>
              <div>
                ...
                <div>
                  <a href="https://coveralls.io/github/ayroblu/object-type-check?branch=master">
                    <img
                      src="https://coveralls.io/repos/github/ayroblu/object-type-check/badge.svg?branch=master"
                      alt="object type check coverage"
                    />
                  </a>
                  <p>
                    This is a runtime type checker, I wrote this for verifying
                    serialised data, has 100% test coverage
                  </p>
                  <a
                    className="source-link no-color"
                    href="https://github.com/ayroblu/object-type-check"
                  >
              ...
              <div>
                ...
                <div>
                  <p>
                    React Native Navigation has a very easy drawer system, which
                    means you can add this for a slide in from the right option
                    to display redux data without needing to use JS Debugging
                  </p>
                  <a
                    className="source-link no-color"
                    href="https://github.com/ayroblu/react-native-redux-log-monitor"
                  >
                    <GoMarkGithub size={30} />
                    <span>Source</span>
                  </a>
              ...
              <div>
                ...
                <div>
                  <p>
                    Rather than using migrations, its probably easier just to
                    calculate a diff between a lock configuration and an
                    existing database
                  </p>
                  <a
                    className="source-link no-color"
                    href="https://github.com/ayroblu/db-difftool"
                  >
                    <GoMarkGithub size={30} />
                    <span>Source</span>
                  </a>
              ...
              <div>
                ...
                <div>
                  ...
                  <a
                    className="source-link no-color"
                    href="https://github.com/ayroblu/redux-add"
                  >
                    <GoMarkGithub size={30} />
                    <span>Source</span>
                  </a>
          ...
          <div id="projects">
            ...
            <div>
              <TitleLink>
                <a href="https://aklbuses.nz">Live Auckland Buses</a>
              </TitleLink>
              <p>
                Shows the locations of Auckland buses in real time to the
                nearest 30 seconds because Auckland Transport don't provide a
                simple interface for seeing this kind of information
              </p>
              <div>
              ...
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/aklbuses.nz"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
            ...
            <div>
              <TitleLink>
                <a href="https://webrec.ayro.nz">Video Delay</a>
              </TitleLink>
              <p>
                Chrome has decent video options for recording and playing
                videos, and makes it easy to create a flexible video playback
                system - created for coaching at the Auckland Archery Club
              </p>
              <p>
                Uses electron for packaging an offline, desktop cross platform
                app
              </p>
              <div className="captionedImage">
                <img src={videoDelay} alt="Archery Video Delay" />
                <span className="caption">
                  Cameras from multiple angles with a light panel for the archer
                  to check their form post shot
                </span>
              </div>
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/video-delay"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
          ...
          <div id="react-native" className="App-text">
            ...
            <div>
              ...
              <p>
                Is a basic showcase of some of the basic skills associated with
                React Native development. This includes adding React Native
                Navigation and Realm, and various Jest testing, it probably
                could be improved to showcase some of the more advanced skills
                but feel free to discuss these with me
              </p>
              <div>
                <a
                  className="source-link no-color"
                  href="https://github.com/ayroblu/ArcheryNotes"
                >
                  <GoMarkGithub size={30} />
                  <span>Source</span>
                </a>
          ...
          <div id="android" className="App-text">
            ...
            <div>
              ...
              <a href="https://play.google.com/store/apps/details?id=benl.student.archeryscorer">
                <img
                  ...
                  alt="Archery Scorer Link"
                />
              </a>
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/ArcherScorer"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
            ...
            <div>
              ...
              <p>
                An app I wrote for checking the weather and traffic because it
                was too frustrating to use publicly provided weather and traffic
                cameras on my phone
              </p>
              <a href="https://play.google.com/store/apps/details?id=benl.student.datacol&hl=en">
                <img
                  src={gplayLogo}
                  className="GoogleLink"
                  alt="NZ Weather and Traffic Link"
                />
              </a>
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/nzWeatherTraffic"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
          ...
          <div id="other-projects">
            ...
            <div className="App-text">
              <TitleLink>
                <a href="http://royalgameofur.site">Royal Game of Ur</a>
              </TitleLink>
              <p>
                Based on this fantastic video, where the basic rules are
                explained
              </p>
            </div>
            ...
            <div className="App-text">
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/royal-game-of-ur"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
            ...
            <div className="App-text">
              <TitleLink>
                <a href="https://ayro.nz">Ayro Site</a>
              </TitleLink>
              ...
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/ayro.nz"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
            ...
            <div className="App-text">
              <TitleLink>
                <a href="https://archery.ayro.nz">Archery Calculator</a>
              </TitleLink>
              <p>
                This is just a simple website I've created for calculating sight
                marks using projective motion equations, note the math is
                further below. With two sight marks, you can work out all other
                sight marks. It uses a basic bisection method for equation
                solving
              </p>
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/archery-toolbox"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
            ...
            <div>
              <TitleLink>
                <a href="http://ben-l.com">My First Site</a>
              </TitleLink>
              <p>
                This is my first ever website, hosted on google apps, with
                python, and has a pretty nice transition which was built to be
                compatible (limited) with ie6
              </p>
              <div className="captionedImage">
                {isPaused && <div className="tapper">Tap here</div>}
                <video muted autoPlay type="video/mp4" loop>
                  <source src={firstWebVid} type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
                <span className="caption">
                  My First Website, animating through auto typing out text based
                  on "Chuck" tv show, note how the cursor does not start from
                  the center
                </span>
              </div>
              <a
                className="source-link no-color"
                href="https://github.com/ayroblu/personal-website-first"
              >
                <GoMarkGithub size={30} />
                <span>Source</span>
              </a>
          ...
          <div id="university">
            ...
            <div>
              ...
              <p>
                Major in Economics, including international trade, how
                environmental factors affect how countries struggle or thrive in
                different conditions.
              </p>
              <p>
                Various topics in finance, including Black–Scholes, put call
                parity, Discounted Cash Flows and analyzing corporate finances
              </p>
              <p>
                Various topics in entrepreneurship, including Venture Capital,
                Cap tables, IPOs and valuations
              </p>
            </div>
            <div className="App-text">
              <h3>
              ...
              <p>
                This degree covered many different mathematical and modelling
                topics including Operations Research, Fluid Dynamics, Geothermal
                Engineering and Software Development
              </p>
              <p>
                Below are some pictures from a Geothermal course and from my
                Honours project
              </p>
            </div>
            <div className="App-videos">
              <div className="captionedImage">
                <img
                  className="FullSize"
                  src={geotherm}
                  alt="Production data for example geothermal field"
                />
                <span className="caption">
            ...
            <div>
              <img
                src={uw}
                alt="University of Washington Quad"
                className="FullSize"
              />
            </div>
          </div>
          <div id="archery">
            ...
            <div className="App-text">
              ...
              <p>
                These are just some basic projectile motion equations which
                allow you to solve for arrow positioning
              </p>
            </div>
            <MathJax.Context>
